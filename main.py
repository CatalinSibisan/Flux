...
# frame for song list
songs_area = customtkinter.CTkScrollableFrame(app, width=200, height=480, fg_color=('#1F3291'),
                                               label_text="Rap", label_fg_color=('#08186C'), 
...
for i in range(20):
    customtkinter.CTkButton(songs_area, hover_color=('#192879'),
                             text=f"{i + 1}| Nume piesa                      timp",
                               width= 200, fg_color = 'transparent').pack(padx= 2, pady = 2)
...
progressBar = customtkinter.CTkSlider(buttons_area, width = 400, from_ = 0, to = 100, 
                                      ...
                                      progress_color="#1F3291", button_color="#08186C", button_hover_color="#192879", state = "disable")
progressBar.set(0)
...
play_button = customtkinter.CTkButton(buttons_area, font=font_PB, hover_color=('#192879'), 
                                      text = text_pb, width= 50, height= 50, fg_color=('#1F3291'),
                                        corner_radius= 100, command=play_song)
